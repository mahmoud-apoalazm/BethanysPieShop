namespace BethanysPieShop.Models
{
    public class MockPieRepository : IPieRepository
    {
        ...
        {
            get { return AllPies.Where(p=>p.IsPieOfTheWeek).ToList(); }
        }
